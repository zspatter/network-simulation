class Node:
    ...
    def __init__(self, node_id, label='Default Node', adjacency_dict=None, status=None):
        ...
        :param dict adjacency_dict: {int node_id: {'weight': int, 'status': bool}, ...} (None by default)
        :param bool status: flag indicating whether a node is active or inactive (None by default)
        """
