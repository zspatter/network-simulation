...
def test_add_node():
    ...
    assert len(test_net.node_ids()) is 0
    test_net.add_node(node1)
    assert len(test_net.node_ids()) is 1
    assert node1.node_id in test_net.node_ids()
...
def test_remove_node():
    ...
    assert len(test_net.node_ids()) is 2
...
def test_mark_node_inactive():
    ...
    assert len(test_net.network_dict) is len(test_net.node_ids())
    ...
    assert len(test_net.network_dict) is 2
    assert len(test_net.network_dict) is not len(test_net.node_ids())
...
def test_nodes():
    ...
    assert len(test_net.node_ids()) is 2
    assert len(test_net.node_ids()) is len(test_net.network_dict)
    assert node1.node_id in test_net.node_ids()
    assert node2.node_id in test_net.node_ids()
    ...
    test_net.mark_node_inactive(node1.node_id)
    assert len(test_net.node_ids()) is 1
    assert len(test_net.node_ids()) is not len(test_net.network_dict)
    assert len(test_net.network_dict) is 2
    assert node1.node_id not in test_net.node_ids()
    assert node2.node_id in test_net.node_ids()
    ...
    assert len(test_net.network_dict) is 2
    assert node1.node_id not in test_net.node_ids()
    assert node2.node_id not in test_net.node_ids()
