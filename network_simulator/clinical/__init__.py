...
from network_simulator.clinical.gates import GATES_BY_ORGAN, crossmatch_gate, size_gate
...
from network_simulator.clinical.size import body_size, size_compatible
