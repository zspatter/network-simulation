...
TierClassifier (see network_simulator.allocation.geography), running it in ascending-tier
...
from network_simulator.allocation.base import (
    AllocationResult,
    MatchingAlgorithm,
    ScoringFunction,
    feasible_match,
...
from network_simulator.allocation.geography import TierClassifier
