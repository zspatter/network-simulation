...
# harvest_organ_1 = O.Organ(organ_type=O.Organ.PANCREAS, blood_type=bT.BloodType(BloodTypeLetter.A, BloodTypePolarity.NEG),
#                           location=hospital_a.node_id)
# harvest_organ_2 = O.Organ(organ_type=O.Organ.HEART, blood_type=bT.BloodType(BloodTypeLetter.A, BloodTypePolarity.NEG),
#                           location=hospital_a.node_id)
# harvest_organ_3 = O.Organ(organ_type=O.Organ.LIVER, blood_type=bT.BloodType(BloodTypeLetter.A, BloodTypePolarity.NEG),
#                           location=hospital_a.node_id)
# harvest_organ_4 = O.Organ(organ_type=O.Organ.LUNG, blood_type=bT.BloodType(BloodTypeLetter.A, BloodTypePolarity.NEG),
#                           location=hospital_a.node_id)
#
...
graph = gB.GraphBuilder.graph_builder(15)
organ_list = oL.OrganList()
